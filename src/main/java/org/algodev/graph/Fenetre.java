...
import org.algodev.graph.poker.AffichagePoker;
...
public class Fenetre {
    ...
    private void creeMenu() throws FileNotFoundException {
        ...
        bpoker.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                {im.setImage(new Image(String.valueOf(this.getClass().getResource("/poker.jpg"))));
                    ...
                    AffichagePoker affichagePoker = new AffichagePoker(s1);
                    s1.hide();
                    jeux = 4;
                }interjeux();
        ...
        credit.setLayoutX(10);
        credit.setLayoutY(975);
        credit.setText("Credits");
        credit.setOnMouseClicked(mouseEvent -> {
            Credits credits = new Credits(s1);
            s1.hide();
        });
