...
public class InterfaceBatailleNaval {
        ...
        for(int i = 0; i < 5 ; i++)
        {
            ...
            while (!trouver)
            {
                ...
                if(traitementj2.verifPlacement(x+1,y+1,taillebateaux[i],orientation(o))){
                    trouver = true;
                    traitementj2.placerBateau(x+1,y+1,taillebateaux[i],orientation(o),0);
                }
            }
        }
    }
                            ...
                            if(!etatplacement && !afficher)
                            {
                                ...
                                rb.setOnMouseClicked(new EventHandler<MouseEvent>() {
                                    ...
                                    public void handle(MouseEvent mouseEvent) {
                                        ...
                                        {
                                            traitementj1.placerBateau(finalI+1,finalJ+1,taillebateaux[k],orientation(direction),0);
                                            valider[0] = true;
                                            k++;
    ...
    private void afficherAttaque(int x, int y,boolean p2)
    {
        ...
        System.out.println("x" +x+"y"+y+"p"+p2);
