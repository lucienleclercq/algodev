...
public class Grille {
    ...
    /**
     * Cr√©er la grille en fonction des valeurs pass√©s en param√®tre
    ...
    /**
     * Met directement une case ‡ des coordonnÈes donnÈes
     * @param i CoordonnÈe de la ligne
     * @param j CoordonnÈe de la colonne
     * @param c	Case ‡ ajouter aux coordonnÈes
     */
    ...
    /**
     * Affiche la grille, c'est une m√©thode de test, ne pas utiliser dans le projet final
     */
    ...
    /**
     * Permet de d√©composer un string. Chaque caract√®re doit √™tre s√©parer d'un esapace pour fonctionner
     * @param valeurs Une chaine de caract√®res
     */
